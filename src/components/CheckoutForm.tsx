...
export default function CheckoutForm() {
  const { content, activePath } = useTheme();
  ...
  const handleSubmitDetails = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/api/checkout", {
        ...
        body: JSON.stringify({ ...formData, path: activePath }),
      });
      if (res.ok) {
  ...
  return (
    <section id="checkout" className="relative py-24 sm:py-32 overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-b from-[var(--theme-bg)] via-[#0D0D0D] to-[var(--theme-bg)]" />
      <div
      ...
      <div className="relative z-10 max-w-xl mx-auto px-6">
        ...
        <motion.div
          layout
          className="bg-gradient-to-br from-[var(--theme-bg-card)] to-[#111] border border-white/10 rounded-[32px] p-8 sm:p-10 overflow-hidden"
        >
          <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full bg-white/5 border ${
                      errors.name ? "border-[var(--theme-primary)]" : "border-white/10"
                    } rounded-2xl py-4 pr-12 pl-4 text-white placeholder-gray-500 focus:outline-none focus:border-[var(--theme-primary)]/50 focus:ring-1 focus:ring-[var(--theme-primary)]/20 transition-all font-[family-name:var(--font-heebo)]`}
                  />
                  {errors.name && (
                    <p className="text-[var(--theme-primary)] text-xs mt-1 pr-4">{errors.name}</p>
                  )}
                </div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full bg-white/5 border ${
                      errors.phone ? "border-[var(--theme-primary)]" : "border-white/10"
                    } rounded-2xl py-4 pr-12 pl-4 text-white placeholder-gray-500 focus:outline-none focus:border-[var(--theme-primary)]/50 focus:ring-1 focus:ring-[var(--theme-primary)]/20 transition-all font-[family-name:var(--font-heebo)]`}
                    dir="ltr"
                  />
                  {errors.phone && (
                    <p className="text-[var(--theme-primary)] text-xs mt-1 pr-4">{errors.phone}</p>
                  )}
                </div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full bg-white/5 border ${
                      errors.email ? "border-[var(--theme-primary)]" : "border-white/10"
                    } rounded-2xl py-4 pr-12 pl-4 text-white placeholder-gray-500 focus:outline-none focus:border-[var(--theme-primary)]/50 focus:ring-1 focus:ring-[var(--theme-primary)]/20 transition-all font-[family-name:var(--font-heebo)]`}
                    dir="ltr"
                  />
                  {errors.email && (
                    <p className="text-[var(--theme-primary)] text-xs mt-1 pr-4">{errors.email}</p>
                  )}
                </div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.99 }}
                  className="w-full cta-glow bg-[var(--theme-primary)] hover:bg-[var(--theme-primary-light)] disabled:opacity-50 text-white font-[family-name:var(--font-heebo)] font-bold text-lg py-4 rounded-2xl transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer"
                >
                  {loading ? (
            ...
            {step === "payment" && (
              ...
              >
                <div
                  className="inline-flex items-center justify-center w-16 h-16 rounded-2xl text-[var(--theme-primary)] mb-2"
                ...
                <p className="text-[var(--theme-primary)] text-sm font-semibold font-[family-name:var(--font-heebo)]">
                ...
                <motion.a
                  ...
                  className="inline-flex items-center gap-3 cta-glow bg-[var(--theme-primary)] hover:bg-[var(--theme-primary-light)] text-white font-[family-name:var(--font-heebo)] font-bold text-lg px-10 py-4 rounded-2xl transition-all duration-300 cursor-pointer"
                >
