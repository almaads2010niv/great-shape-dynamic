    ...
    <section className="relative py-24 sm:py-32 overflow-hidden">
      <div className="relative z-10 max-w-4xl mx-auto px-6">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }} className="relative">
          <div className="relative rounded-[32px] p-10 sm:p-14 overflow-hidden" style={{ backgroundColor: "var(--theme-primary)" }}>
            ...
            <div className="relative z-10 text-center">
              <motion.div initial={{ scale: 0 }} whileInView={{ scale: 1 }} viewport={{ once: true }} transition={{ type: "spring", stiffness: 200, delay: 0.3 }} className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-white/20 backdrop-blur-sm mb-8">
              ...
              <h2 className="font-[family-name:var(--font-heebo)] font-black text-3xl sm:text-4xl md:text-5xl text-white mb-8 leading-tight">
                אפס סיכון.<br />אפס חששות.<br />רק הזדמנות.
              </h2>

              <div className="text-white/90 text-lg sm:text-xl max-w-2xl mx-auto leading-relaxed mb-8 space-y-5">
                <p>
                  אנחנו מורידים את כל החסמים.
                  במקום לחכות, לעמוד בתור או לדבר עם נציגים –
                ...
                <p className="text-white font-bold text-xl sm:text-2xl pt-2">
                  ...
                  <br />ההחלטה תמיד נשארת בידיים שלכם.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2.5">
                  ...
                  <span className="text-white text-sm font-semibold font-[family-name:var(--font-heebo)]">תשלום מאובטח</span>
                </div>
                <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2.5">
                  <ShieldCheck className="w-4 h-4 text-white" />
                  <span className="text-white text-sm font-semibold font-[family-name:var(--font-heebo)]">ללא התחייבות</span>
                </div>
              </div>
            </div>
          </div>
